...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("rounded-xl border border-slate-800 bg-slate-900 text-white shadow-sm", className)}
    {...props}
  />
))
...
const CardFooter = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-5 pt-0 border-t border-slate-800", className)}
    {...props}
  />
))
